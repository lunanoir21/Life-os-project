const en = {
  ...
  habits: {
    ...
    gapForgiveness: 'Miss tolerance',
    gapForgivenessHint: 'missed days the streak survives',
  ...
  journal: {
    ...
    templates: {
      morning: {
        ...
        desc: 'Start the day intentionally',
        content: "Today's focus:\n1. \n2. \n3. \n\nHow I'm feeling this morning:\n\nTop priority of the day:",
      },
      daily: {
        name: 'Daily Reflection',
        desc: 'Process the day evenly',
        content: 'What went well today:\n\nWhat I learned:\n\nWhat I could have done differently:\n\nNotes for tomorrow:',
      },
      weekly: {
        name: 'Weekly Review',
        desc: 'Look back at the week',
        content: 'What I completed this week:\n\nWhat I learned this week:\n\nChallenges I faced:\n\nGoals for next week:\n1. \n2. \n3. ',
      },
    },
  ...
  finance: {
    ...
    converter: {
      ...
      subtitle: 'Live mid-market rate from the European Central Bank',
      from: 'From',
      to: 'To',
      amount: 'Amount',
      result: 'Result',
  ...
  timeTracker: {
    ...
    noEntriesStart: 'No time entries today. Start tracking!',
