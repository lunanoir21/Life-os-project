...
const tr: TranslationKeys = {
  ...
  tasks: {
    ...
    markAsTodo: 'Yapılacak Olarak İşaretle',
    moveTo: 'Taşı',
    filterAll: 'Tümü',
  ...
  habits: {
    ...
    gapForgiveness: 'Kaçırma toleransı',
    gapForgivenessHint: 'gün seriyi bozmaz',
  ...
  timeTracker: {
    ...
    whatAreYouWorkingOn: 'Ne üzerinde çalışıyorsun?',
    linkToTask: 'Göreve bağla...',
    noEntriesStart: 'Bugün henüz zaman kaydı yok. Takibe başla!',
